...
inline void rdm_contributions_4( wfn_t<N> bra, wfn_t<N> ket, wfn_t<N> ex, 
  T val, rank4_span<T> trdm ) {
...
template <typename T, size_t N>
inline void rdm_contributions_22( 
...
inline void rdm_contributions_2( 
  wfn_t<N> bra, wfn_t<N> ket, wfn_t<N> ex,
  const IndexType& bra_occ_alpha, const IndexType& bra_occ_beta,
  T val, matrix_span<T> ordm, rank4_span<T> trdm) {
...
inline void rdm_contributions_diag( 
  const IndexType& occ_alpha, const IndexType& occ_beta,
  T val, matrix_span<T> ordm, rank4_span<T> trdm ) {
