...
public:
  ...
  virtual sparse_matrix_type<int64_t> 
    make_csr_hamiltonian_block_64bit_(
      full_det_iterator, full_det_iterator, full_det_iterator, 
      full_det_iterator, double ) = 0;
...
public:
  ...
  double fast_diag_os_double( 
    const std::vector<uint32_t>& up_occ, 
