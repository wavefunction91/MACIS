...
sparsexx::csr_matrix<double,index_t> make_csr_hamiltonian_block(
  typename std::vector< std::bitset<N> >::iterator bra_begin,
  typename std::vector< std::bitset<N> >::iterator bra_end,
  typename std::vector< std::bitset<N> >::iterator ket_begin,
  typename std::vector< std::bitset<N> >::iterator ket_end,
...
sparsexx::dist_sparse_matrix< sparsexx::csr_matrix<double,index_t> >
  make_dist_csr_hamiltonian( MPI_Comm comm, 
                             typename std::vector<std::bitset<N>>::iterator sd_begin,
                             typename std::vector<std::bitset<N>>::iterator sd_end,
                             HamiltonianGenerator<N>&        ham_gen,
