...
void generalized_fock_matrix( NumOrbital _norb, NumInactive _ninact,
  NumActive _nact, const double* Fi, size_t LDFi, const double* Fa,
...
void generalized_fock_matrix_comp_mat1( NumOrbital _norb, 
  NumInactive _ninact, NumActive _nact, const double* Fi, size_t LDFi,
  ...
  active_fock_matrix( _norb, _ninact, _nact, V_full, LDV,
    A1RDM, LDD1, F_active.data(), norb);

  // Compute Q
  std::vector<double> Q(nact * norb);
  aux_q_matrix(_nact, _norb, _ninact, V_full, LDV, A2RDM, LDD2,
    Q.data(), nact);

  // Compute Generalized Fock Matrix
  generalized_fock_matrix(_norb, _ninact, _nact, Fi, LDFi,
    F_active.data(), norb, A1RDM, LDD1, Q.data(), nact,
    F, LDF);
  
} 

void generalized_fock_matrix_comp_mat2( NumOrbital _norb, 
  NumInactive _ninact, NumActive _nact, const double* T, size_t LDT,
  const double* V_full, size_t LDV, 
  const double* A1RDM, size_t LDD1, const double* A2RDM,
  size_t LDD2, double* F, size_t LDF ){
  ...
  inactive_fock_matrix(_norb, _ninact, T, LDT, V_full, LDV,
    Fi.data(), norb);

  generalized_fock_matrix_comp_mat1(_norb, _ninact, _nact, 
